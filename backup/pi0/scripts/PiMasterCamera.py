...
def broadcast_Picture():
    ...
    picam2.configure(picam2.create_still_configuration(buffer_count = 3, main={"format": "RGB888", "size": (4608, 2592)},
    ...
    config = picam2.create_still_configuration(buffer_count = 3, main={"format": "RGB888", "size": (4608, 2592)}, #tester queue = False
    ...
    picam2.start()
    ip_list = ["192.168.0.103"]  # "192.168.0.103",
